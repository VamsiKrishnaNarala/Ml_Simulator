  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden border-b border-border/70 bg-background">
        ...
        />
        <div className="relative mx-auto grid max-w-7xl gap-10 px-5 py-16 sm:py-20 lg:grid-cols-[1.1fr_1fr] lg:py-28">
          <div className="flex flex-col justify-center">
            <Eyebrow>A machine learning laboratory, in your browser</Eyebrow>
            <h1 className="font-display text-4xl font-semibold leading-[1.08] tracking-tight text-primary sm:text-5xl lg:text-6xl">
              Machine Learning,
              <br />
              <span className="text-brand">you can see.</span>
            </h1>
          ...
          <div className="relative min-h-[320px] overflow-hidden rounded-2xl border border-border bg-surface lg:min-h-[420px]">
            <HeroCanvas />
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:py-20">
        ...
        <h2 className="font-display text-3xl font-semibold text-primary sm:text-4xl">What you'll learn</h2>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {topics.map((t) => (
            <Panel key={t.title} className="transition hover:border-primary/40 hover:shadow-glow">
              ...
              <h3 className="mt-3 font-display text-lg font-semibold text-primary">{t.title}</h3>
              <p className="mt-1.5 text-sm leading-relaxed text-secondary">{t.desc}</p>
            </Panel>
          ))}
        </div>
      </section>
      ...
      {/* How it works strip */}
      <section className="border-t border-border/70 bg-surface-secondary">
