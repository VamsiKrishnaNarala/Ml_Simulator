  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden border-b border-default/70">
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 sm:py-20 lg:grid-cols-[1.1fr_1fr] lg:py-28">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="font-display text-4xl font-semibold leading-[1.08] tracking-tight text-brand sm:text-5xl lg:text-6xl">
              Machine Learning,
              <br />
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:py-20">
        ...
        <h2 className="font-display text-3xl font-semibold text-brand sm:text-4xl">What you'll learn</h2>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {topics.map((t) => (
            <Panel key={t.title} className="transition hover:border-brand/40 hover:shadow-glow">
              <t.icon className="h-5 w-5 text-brand" strokeWidth={1.75} />
              <h3 className="mt-3 font-display text-lg font-semibold text-brand">{t.title}</h3>
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            {[
              ...
              <div key={s.n}>
                ...
                <h3 className="mt-2 font-display text-xl font-semibold text-brand">{s.title}</h3>
