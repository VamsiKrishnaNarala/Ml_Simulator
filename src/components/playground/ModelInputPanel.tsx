...
export const ModelInputPanel: React.FC<ModelInputPanelProps> = ({
  ...
  return (
    <div className="bg-surface-secondary border border-default rounded-lg p-4 text-primary text-sm">
      <h3 className="font-semibold text-lg mb-4">Model Input Summary</h3>

      <div className="space-y-6">
        {/* Section 1: Dimensions */}
        <div>
          <h4 className="text-muted mb-2 border-b border-default/60 pb-1">Dimensions</h4>
        ...
        <div>
          <h4 className="text-muted mb-2 border-b border-default/60 pb-1">Features Used</h4>
          <ul className="font-mono space-y-1 bg-surface p-2 rounded">
            ...
            {mode !== 'clustering' && (
              <li className="mt-1 pt-1 border-t border-default/30">
        ...
        <div>
          <h4 className="text-muted mb-2 border-b border-default/60 pb-1">Train / Test Split</h4>
        ...
        <div>
          <h4 className="text-muted mb-2 border-b border-default/60 pb-1">Preprocessing Applied</h4>
        ...
        <div>
          <h4 className="text-muted mb-2 border-b border-default/60 pb-1">
